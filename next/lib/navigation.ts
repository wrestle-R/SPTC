...
export const navigation: NavGroup[] = [
  {
    ...
    items: [
      ...
      { title: "Arrivals Verification", href: "/organizer/arrivals-verification", icon: ImageUp },
      { title: "Early Bird Verification", href: "/organizer/early-bird-verification", icon: Trophy },
