...
const rosterNames = {
  crimson: [
    ...
    "Suja Jebakumar", "Christy Jagdish", "Kaitlyn Eve",
  ],
  gladiators: [
    "Patrick Joshua", "Edben Kruze", "Jeshurun Edwin", "John Rajesh", "Febin Jagdish",
    "Jeffrey Jebakumar", "Eric Edison", "Ditto Lazar", "Benson Wilson", "Joselin Daniel",
  ...
  knights: [
    ...
    "Abraham Joyal", "Ethan Russel", "Robins Duncan", "Jackson Andrews", "Eunice Edison",
    "Celeste Ditto", "Euvance Edison", "Joselin Golda", "Jas Johh", "Jency Sony",
    "Stella Daniel", "Ansel James",
  ],
  ivory: [
    "Sheldon Benson", "Harrison Peter", "Akshay James", "Immanuel J", "Kevin Joash",
    "Frederick John", "Jovin Daniel", "Austin Sundarraj", "Robinson Samuel", "Jebakumar",
    "Jebastin David", "Alecia Wilson", "Johannah Jackson", "Andrea Prakash", "Rhowena Robinson",
    "Rani Edwin", "Geeta Benson", "Thulasi Edwin", "Annette Maria",
  ],
} as const;
