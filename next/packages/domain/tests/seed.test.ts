...
const expectedRosters = {
  ...
  "gods-gladiators": ["Patrick Joshua", "Edben Kruze", "Jeshurun Edwin", "John Rajesh", "Febin Jagdish", "Jeffrey Jebakumar", "Eric Edison", "Jabez Singh", "Richard", "Ditto Lazar", "Benson Wilson", "Joselin Daniel", "Rheanna Robinson", "Maria Antony", "Andrea Joyal", "Jyotimani Wilson", "Esther Robins", "Sumitha Jackson", "Candice Jebastin", "Judith John", "Edwin Jesudas"],
...
const expectedJerseyNumbers = {
  ...
  "gods-gladiators": [9, 22, 10, 1, 12, 7, 4, 28, null, 1, 18, 7, 11, 14, 13, 9, 2, 17, 5, 23, null],
...
describe("finalized rosters", () => {
  ...
  it("contains 83 unique player records", () => {
    expect(S9_PLAYERS).toHaveLength(83);
    expect(new Set(S9_PLAYERS.map((player) => player.id)).size).toBe(83);
  });
