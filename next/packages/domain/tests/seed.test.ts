...
const expectedRosters = {
  "crimson-warriors": ["Daniel Russel Paul", "Glen Gladin", "Sam Jeyaraj", "Jovin Samraj", "Melvin Benn", "Aaron Ditto", "Johan Jagdish", "Christina Micheal", "Jenson Shaji", "Daniel Ratnaraj", "Edwin Anburaj", "Jemima John", "Rachel Edwin", "Hannah Mano", "Sharon Jane", "Cressida Jebastin", "Suja Jebakumar", "Christy Jagdish", "Anita Ditto", "Kaitlyn Eve", "Aldan Prince"],
...
const expectedJerseyNumbers = {
  ...
  "ivory-elites": [10, 14, 11, 8, 9, 7, 29, 9, null, 4, 5, 21, 7, 22, 32, 24, 4, 17, 6, null, 7],
} as const;
...
describe("finalized rosters", () => {
  ...
  it("contains 81 unique player records", () => {
    expect(S9_PLAYERS).toHaveLength(81);
    expect(new Set(S9_PLAYERS.map((player) => player.id)).size).toBe(81);
  });
