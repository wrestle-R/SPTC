...
| # | Task | Status | Notes |
|---|------|--------|-------|
| 2.1 | Downgrade expo-organizer `package.json` | ⏳ | ~57.0.7 → 54.0.8 |
| 2.2 | Downgrade expo-viewer `package.json` | ⏳ | ~57.0.7 → 54.0.8 |
| 2.3 | Update all Expo sub-packages to SDK 54 versions | ⏳ | See CHANGES.md for full list |
| 2.4 | Update React/React Native versions | ⏳ | react 18.3.x, RN 0.76.x |
| 2.5 | Verify no breaking API changes (expo-router 4.x) | ⏳ | Check migration guide |
| 2.6 | Run `npm ci` in both apps to verify | ⏳ | |
...
| 3.5 | Responsive checks on both apps | ⏳ | various screen sizes |
| 3.6 | Run `npm ci` on both apps | ⏳ | verify clean install |
| 3.7 | Verify web endpoints against Vercel | ⏳ | https://sptc-fiesta.vercel.app |
...
| # | Task | Status | Notes |
|---|------|--------|-------|
| 16.1 | Install `@rnr/reusables` package | ⏳ | |
| 16.2 | Replace custom components with reusables | ⏳ | |
